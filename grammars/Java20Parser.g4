...
classInstanceCreationExpression
    : unqualifiedClassInstanceCreationExpression                      #classInstanceCreationExpression1
    | expressionName '.' unqualifiedClassInstanceCreationExpression   #classInstanceCreationExpression2
    | primary '.' unqualifiedClassInstanceCreationExpression          #classInstanceCreationExpression3
    ;
...
postfixExpression
    : primary pfE?        #postfixExpression1
    | expressionName pfE? #postfixExpression2
    ;
...
preIncrementExpression
    : '++' unaryExpression         #unaryExpression6
    ;

preDecrementExpression
    : '--' unaryExpression         #unaryExpression7
    ;

unaryExpressionNotPlusMinus
    : postfixExpression            #unaryExpression8
    | '~' unaryExpression          #unaryExpression9
    | '!' unaryExpression          #unaryExpression10
    | castExpression               #unaryExpression11
    | switchExpression             #unaryExpression12
    ;

...
class ASTListener(Java20ParserListener):
    ...
    def enterLabeledStatement(self, ctx: Java20Parser.LabeledStatementContext):
        print("!!!!!!!!!!! Labeled Statement Not Implemented! !!!!!!!!!!!!!")
        print("pos:", Pos(ctx.start.line, ctx.start.column))
        exit(0)

    def enterLabeledStatementNoShortIf(self, ctx: Java20Parser.LabeledStatementNoShortIfContext):
        print("err: !!!!!!!!!!! Labeled Statement Not Implemented! !!!!!!!!!!!!")
        print("pos:", Pos(ctx.start.line, ctx.start.column))
        exit(0)
